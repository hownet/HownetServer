...
{
	/// <summary>
	/// EXP_DevelopSampleSupplyType
	/// </summary>
	public partial class EXP_DevelopSampleSupplyType
	{
		private readonly Hownet.DAL.EXP_DevelopSampleSupplyType dal=new Hownet.DAL.EXP_DevelopSampleSupplyType();
		...
		{
			List<Hownet.Model.EXP_DevelopSampleSupplyType> li = DataTableToList(dt);
			int a=0;
			if (li.Count > 0)
			{
		...
		/// 获得数据列表
		/// </summary>
		public List<Hownet.Model.EXP_DevelopSampleSupplyType> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Hownet.Model.EXP_DevelopSampleSupplyType> DataTableToList(DataTable dt)
		{
			List<Hownet.Model.EXP_DevelopSampleSupplyType> modelList = new List<Hownet.Model.EXP_DevelopSampleSupplyType>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Hownet.Model.EXP_DevelopSampleSupplyType model;
				for (int n = 0; n < rowsCount; n++)
				{
					model = new Hownet.Model.EXP_DevelopSampleSupplyType();
					...
					model.SupplyTypeEn=dt.Rows[n]["SupplyTypeEn"].ToString();
					model.ISStock=dt.Rows[n]["ISStock"].ToString();
					model.ContractType=dt.Rows[n]["ContractType"].ToString();
