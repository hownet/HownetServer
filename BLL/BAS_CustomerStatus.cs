...
namespace Hownet.BLL
{
	...
	{
		private readonly Hownet.DAL.BAS_CustomerStatus dal=new Hownet.DAL.BAS_CustomerStatus();
		...
		{
			List<Hownet.Model.BAS_CustomerStatus> li = DataTableToList(dt);
			int a=0;
			if (li.Count > 0)
			{
		...
		/// 获得数据列表
		/// </summary>
		public List<Hownet.Model.BAS_CustomerStatus> GetModelList(string strWhere)
		{
