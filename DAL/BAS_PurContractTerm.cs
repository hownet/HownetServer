...
namespace Hownet.DAL
{
	...
	public partial class BAS_PurContractTerm
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("ID", "BAS_PurContractTerm"); 
		}
		...
		public bool Exists(int ID)
		{
			...
			strSql.Append("select count(1) from BAS_PurContractTerm");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into BAS_PurContractTerm(");
			strSql.Append("TotalCode,TotalContent,IsDef,IsEnd)");
			...
			parameters[2].Value = model.IsDef;
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update BAS_PurContractTerm set ");
		...
		public bool Delete(int ID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from BAS_PurContractTerm ");
			strSql.Append(" where ID=@ID");
			SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)
};
		...
		public Hownet.Model.BAS_PurContractTerm GetModel(int ID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 TotalCode,TotalContent,ID,IsDef,IsEnd from BAS_PurContractTerm ");
			strSql.Append(" where ID=@ID");
			SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)
};
			...
			Hownet.Model.BAS_PurContractTerm model=new Hownet.Model.BAS_PurContractTerm();
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  1 as A,TotalCode,TotalContent,ID,IsDef,IsEnd ");
			strSql.Append(" FROM BAS_PurContractTerm ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" TotalCode,TotalContent,ID,IsDef,IsEnd ");
			strSql.Append(" FROM BAS_PurContractTerm ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "BAS_PurContractTerm";
