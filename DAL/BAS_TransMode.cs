...
namespace Hownet.DAL
{
	...
	public partial class BAS_TransMode
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("ID", "BAS_TransMode"); 
		}
		...
		public bool Exists(int ID)
		{
			...
			strSql.Append("select count(1) from BAS_TransMode");
		...
		/// 增加一条数据
		/// </summary>
		public int Add(Hownet.Model.BAS_TransMode model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into BAS_TransMode(");
			strSql.Append("CnName,EnName,Remark,IsValid,IsDef,IsEnd)");
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(Hownet.Model.BAS_TransMode model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update BAS_TransMode set ");
		...
		public bool Delete(int ID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from BAS_TransMode ");
			strSql.Append(" where ID=@ID");
			SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)
};
		...
		/// 得到一个对象实体
		/// </summary>
		public Hownet.Model.BAS_TransMode GetModel(int ID)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 CnName,EnName,Remark,IsValid,ID,IsDef,IsEnd from BAS_TransMode ");
			strSql.Append(" where ID=@ID");
			SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)
};
			...
			Hownet.Model.BAS_TransMode model=new Hownet.Model.BAS_TransMode();
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  1 as A,CnName,EnName,Remark,IsValid,ID,IsDef,IsEnd ");
			strSql.Append(" FROM BAS_TransMode ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" CnName,EnName,Remark,IsValid,ID,IsDef,IsEnd ");
			strSql.Append(" FROM BAS_TransMode ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "BAS_TransMode";
