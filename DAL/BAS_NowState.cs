...
namespace Hownet.DAL
{
	...
	public partial class BAS_NowState
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("ID", "BAS_NowState"); 
		}
		...
		public bool Exists(int ID)
		{
			...
			strSql.Append("select count(1) from BAS_NowState");
		...
		/// 增加一条数据
		/// </summary>
		public int Add(Hownet.Model.BAS_NowState model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into BAS_NowState(");
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(Hownet.Model.BAS_NowState model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update BAS_NowState set ");
		...
		public bool Delete(int ID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from BAS_NowState ");
			strSql.Append(" where ID=@ID");
			SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)
};
		...
		/// 得到一个对象实体
		/// </summary>
		public Hownet.Model.BAS_NowState GetModel(int ID)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 Code,CnName,EnName,SuccessRate,IsValid,Remark,ID,IsEnd from BAS_NowState ");
			strSql.Append(" where ID=@ID");
			SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)
};
			...
			Hownet.Model.BAS_NowState model=new Hownet.Model.BAS_NowState();
		...
		public DataSet GetList(string strWhere)
		{
			...
			strSql.Append(" FROM BAS_NowState ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "BAS_NowState";
