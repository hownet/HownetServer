...
{
    /// <summary>
    /// 数据访问类:BAS_BodyPart_The
    /// </summary>
    public partial class BAS_BodyPart_The
    {
        public BAS_BodyPart_The()
        { }
        #region  Method
        /// <summary>
        /// 是否存在该记录
        ...
        public bool Exists(long ID)
        {
            ...
            strSql.Append("select count(1) from BAS_BodyPart_The");
        ...
        /// 增加一条数据
        /// </summary>
        public long Add(Hownet.Model.BAS_BodyPart_The model)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("insert into BAS_BodyPart_The(");
            strSql.Append("Code,CnName,EnName,Remark,IsValid,IsDef,IsEnd)");
        ...
        /// 更新一条数据
        /// </summary>
        public bool Update(Hownet.Model.BAS_BodyPart_The model)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update BAS_BodyPart_The set ");
        ...
        public bool Delete(long ID)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete from BAS_BodyPart_The ");
            strSql.Append(" where ID=@ID");
            SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.BigInt)
};
        ...
        /// 得到一个对象实体
        /// </summary>
        public Hownet.Model.BAS_BodyPart_The GetModel(long ID)
        {

            StringBuilder strSql = new StringBuilder();
            strSql.Append("select  top 1 Code,CnName,EnName,Remark,IsValid,ID,IsDef,IsEnd from BAS_BodyPart_The ");
            strSql.Append(" where ID=@ID");
            SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.BigInt)
};
            ...
            Hownet.Model.BAS_BodyPart_The model = new Hownet.Model.BAS_BodyPart_The();
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select  1 as A,Code,CnName,EnName,Remark,IsValid,ID,IsDef,IsEnd ");
            strSql.Append(" FROM BAS_BodyPart_The ");
            if (strWhere.Trim() != "")
            {
        ...
        public DataSet GetList(int Top, string strWhere, string filedOrder)
        {
            ...
            strSql.Append(" Code,CnName,EnName,Remark,IsValid,ID,IsDef,IsEnd ");
            strSql.Append(" FROM BAS_BodyPart_The ");
            if (strWhere.Trim() != "")
            {
                strSql.Append(" where " + strWhere);
        ...
        public DataSet GetList(int PageSize,int PageIndex,string strWhere)
        {
            ...
            parameters[0].Value = "BAS_BodyPart_The";
