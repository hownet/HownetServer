...
namespace Hownet.DAL
{
	...
	public partial class BAS_Currency
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("ID", "BAS_Currency"); 
		}
		...
		public bool Exists(int ID)
		{
			...
			strSql.Append("select count(1) from BAS_Currency");
		...
		/// 增加一条数据
		/// </summary>
		public int Add(Hownet.Model.BAS_Currency model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into BAS_Currency(");
			strSql.Append("Code,EnName,CnName,IsValid,IsLocal,IsEnd)");
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(Hownet.Model.BAS_Currency model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update BAS_Currency set ");
		...
		public bool Delete(int ID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from BAS_Currency ");
			strSql.Append(" where ID=@ID");
			SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)
};
		...
		/// 得到一个对象实体
		/// </summary>
		public Hownet.Model.BAS_Currency GetModel(int ID)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 Code,EnName,CnName,IsValid,ID,IsLocal,IsEnd from BAS_Currency ");
			strSql.Append(" where ID=@ID");
			SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)
};
			...
			Hownet.Model.BAS_Currency model=new Hownet.Model.BAS_Currency();
			...
			if(ds.Tables[0].Rows.Count>0)
			{
				...
				if(ds.Tables[0].Rows[0]["IsLocal"]!=null && ds.Tables[0].Rows[0]["IsLocal"].ToString()!="")
				{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  1 as A,Code,EnName,CnName,IsValid,ID,IsLocal,IsEnd ");
			strSql.Append(" FROM BAS_Currency ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" Code,EnName,CnName,IsValid,ID,IsLocal,IsEnd ");
			strSql.Append(" FROM BAS_Currency ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "BAS_Currency";
