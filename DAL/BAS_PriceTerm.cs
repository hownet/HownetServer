...
namespace Hownet.DAL
{
	...
	/// 数据访问类:BAS_PriceTerm
	/// </summary>
	public partial class BAS_PriceTerm
	{
		public BAS_PriceTerm()
		{}
		#region  Method
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("ID", "BAS_PriceTerm"); 
		}
		...
		public bool Exists(int ID)
		{
			...
			strSql.Append("select count(1) from BAS_PriceTerm");
		...
		/// 增加一条数据
		/// </summary>
		public int Add(Hownet.Model.BAS_PriceTerm model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into BAS_PriceTerm(");
			strSql.Append("Code,EnName,CnName,Remark,IsValid,IsDef,IsEnd)");
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(Hownet.Model.BAS_PriceTerm model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update BAS_PriceTerm set ");
		...
		public bool Delete(int ID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from BAS_PriceTerm ");
			strSql.Append(" where ID=@ID");
			SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)
};
		...
		/// 得到一个对象实体
		/// </summary>
		public Hownet.Model.BAS_PriceTerm GetModel(int ID)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 Code,EnName,CnName,Remark,IsValid,ID,IsDef,IsEnd from BAS_PriceTerm ");
			strSql.Append(" where ID=@ID");
			SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)
};
			...
			Hownet.Model.BAS_PriceTerm model=new Hownet.Model.BAS_PriceTerm();
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  1 as A,Code,EnName,CnName,Remark,IsValid,ID,IsDef,IsEnd ");
			strSql.Append(" FROM BAS_PriceTerm ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" Code,EnName,CnName,Remark,IsValid,ID,IsDef,IsEnd ");
			strSql.Append(" FROM BAS_PriceTerm ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "BAS_PriceTerm";
