...
namespace Hownet.DAL
{
	...
	/// 数据访问类:BAS_QtyUnit
	/// </summary>
	public partial class BAS_QtyUnit
	{
		public BAS_QtyUnit()
		{}
		#region  Method
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("ID", "BAS_QtyUnit"); 
		}
		...
		public bool Exists(int ID)
		{
			...
			strSql.Append("select count(1) from BAS_QtyUnit");
		...
		/// 增加一条数据
		/// </summary>
		public int Add(Hownet.Model.BAS_QtyUnit model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into BAS_QtyUnit(");
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(Hownet.Model.BAS_QtyUnit model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update BAS_QtyUnit set ");
		...
		public bool Delete(int ID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from BAS_QtyUnit ");
			strSql.Append(" where ID=@ID");
			SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)
};
		...
		/// 得到一个对象实体
		/// </summary>
		public Hownet.Model.BAS_QtyUnit GetModel(int ID)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 CnName,EnName,EnNamePlural,EnShortName,EnShortNamePlural,IsValid,ID,IsEnd from BAS_QtyUnit ");
			strSql.Append(" where ID=@ID");
			SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)
};
			...
			Hownet.Model.BAS_QtyUnit model=new Hownet.Model.BAS_QtyUnit();
		...
		public DataSet GetList(string strWhere)
		{
			...
			strSql.Append(" FROM BAS_QtyUnit ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "BAS_QtyUnit";
