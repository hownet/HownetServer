...
namespace Hownet.DAL
{
	...
	public partial class BAS_TradeType
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("ID", "BAS_TradeType"); 
		}
		...
		public bool Exists(int ID)
		{
			...
			strSql.Append("select count(1) from BAS_TradeType");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into BAS_TradeType(");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update BAS_TradeType set ");
		...
		public bool Delete(int ID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from BAS_TradeType ");
			strSql.Append(" where ID=@ID");
			SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)
};
		...
		public Hownet.Model.BAS_TradeType GetModel(int ID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 EnName,CnName,Remark,IsDef,IsValid,ID,IsEnd from BAS_TradeType ");
			strSql.Append(" where ID=@ID");
			SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)
};
			...
			Hownet.Model.BAS_TradeType model=new Hownet.Model.BAS_TradeType();
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  1 as A,EnName,CnName,Remark,IsDef,IsValid,ID,IsEnd ");
			strSql.Append(" FROM BAS_TradeType ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" EnName,CnName,Remark,IsDef,IsValid,ID,IsEnd ");
			strSql.Append(" FROM BAS_TradeType ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "BAS_TradeType";
