...
{
	/// <summary>
	/// 数据访问类:BAS_PaymentType
	/// </summary>
	public partial class BAS_PaymentType
	{
		public BAS_PaymentType()
		{}
		#region  Method
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("ID", "BAS_PaymentType"); 
		}
		...
		public bool Exists(int ID)
		{
			...
			strSql.Append("select count(1) from BAS_PaymentType");
		...
		/// 增加一条数据
		/// </summary>
		public int Add(Hownet.Model.BAS_PaymentType model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into BAS_PaymentType(");
			strSql.Append("Code,EnName,CnName,Remark,CreditRank,IsValid,IsDef,IsEnd)");
			...
			SqlParameter[] parameters = {
					...
					new SqlParameter("@CreditRank", SqlDbType.VarChar,500),
			...
			parameters[4].Value = model.CreditRank;
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(Hownet.Model.BAS_PaymentType model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update BAS_PaymentType set ");
		...
		public bool Delete(int ID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from BAS_PaymentType ");
			strSql.Append(" where ID=@ID");
			SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)
};
		...
		/// 得到一个对象实体
		/// </summary>
		public Hownet.Model.BAS_PaymentType GetModel(int ID)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 Code,EnName,CnName,Remark,CreditRank,IsValid,ID,IsDef,IsEnd from BAS_PaymentType ");
			strSql.Append(" where ID=@ID");
			SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)
};
			...
			Hownet.Model.BAS_PaymentType model=new Hownet.Model.BAS_PaymentType();
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  1 as A,Code,EnName,CnName,Remark,CreditRank,IsValid,ID,IsDef,IsEnd ");
			strSql.Append(" FROM BAS_PaymentType ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" Code,EnName,CnName,Remark,CreditRank,IsValid,ID,IsDef,IsEnd ");
			strSql.Append(" FROM BAS_PaymentType ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "BAS_PaymentType";
