...
namespace Hownet.DAL
{
	...
	public partial class BAS_ExpressType
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("ID", "BAS_ExpressType"); 
		}
		...
		public bool Exists(int ID)
		{
			...
			strSql.Append("select count(1) from BAS_ExpressType");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into BAS_ExpressType(");
			strSql.Append("CnName,EnName,Remark,IsValid,IsEnd)");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update BAS_ExpressType set ");
		...
		public bool Delete(int ID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from BAS_ExpressType ");
			strSql.Append(" where ID=@ID");
			SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)
};
		...
		public Hownet.Model.BAS_ExpressType GetModel(int ID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 CnName,EnName,Remark,IsValid,ID,IsEnd from BAS_ExpressType ");
			strSql.Append(" where ID=@ID");
			SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)
};
			...
			Hownet.Model.BAS_ExpressType model=new Hownet.Model.BAS_ExpressType();
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  1 as A,CnName,EnName,Remark,IsValid,ID,IsEnd ");
			strSql.Append(" FROM BAS_ExpressType ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" CnName,EnName,Remark,IsValid,ID,IsEnd ");
			strSql.Append(" FROM BAS_ExpressType ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "BAS_ExpressType";
