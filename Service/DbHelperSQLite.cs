...
namespace Service
{
    ...
    public abstract class DbHelperSQLite
    {
        ...
        public static string connectionString = " Data Source = " + ServiceForm.Dir + @"\Tables.db";
        ...
        public static DataSet Query(string SQLString)
        {
            ...
            //sqlstr.DataSource = connectionString;// ".\\Tables.db";
            ...
            //{
            //   // connection.Open();
            //    SQLiteDataAdapter command = new SQLiteDataAdapter(SQLString, con);
            //    command.Fill(ds, "ds");
            //}
            //catch (System.Data.SQLite.SQLiteException ex)
            //{
